...
static const int scalepreview       = 7;        /* preview scaling (display w and h / scalepreview) */
...
static const char* sound_up[]= {"sound", "up", NULL};
static const char* sound_down[]= {"sound", "down", NULL};
static const char* sound_mute[]= {"sound", "mute", NULL};

static const char* chlayout[]= {"chlayout", NULL};
...
static const Key keys[] = {
	...
	{ 0,                       		XK_Print,        				spawn, 			SHCMD("scrot -f -s '/tmp/%%F_%%T_$wx$h.png' -e 'xclip -selection clipboard -target image/png -i $f'") },
	{ MODKEY,                       XK_space,  						spawn,          {.v = chlayout} },
